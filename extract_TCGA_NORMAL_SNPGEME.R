...
load("/fh/fast/stanford_j/Xiaoyu/QTL/data/TCGA496normalgenotype.RData")
save(all496normalgenotypedata,genotypedata,geneexpdata,methydata,allnormalgenotypedata,file="/fh/fast/stanford_j/Xiaoyu/QTL/data/TCGAnormals.RData")
#use genotypes from 496 normals in emQTL for tumors 
