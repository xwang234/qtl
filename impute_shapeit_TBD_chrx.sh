...
do_impute2X () {
  ...
  ALL_OUTPUTinfo=$7
  samplefile=$8
  inf=$outfolder/genotypes_chr$chr
...
OUTPUT_HAPS=${outfolder}/genotypes_chr${chr}_PAR1.haps
OUTPUT_SAMPLE=${outfolder}/genotypes_chr${chr}_PAR1.sample
OUTPUT_LOG=${outfolder}/genotypes_chr${chr}_PAR1.log
do_shapeitX $outfolder/genotypes_chr$chr $GENMAP_FILE $OUTPUT_HAPS $OUTPUT_SAMPLE $OUTPUT_LOG
samplefile="/fh/fast/stanford_j/Xiaoyu/QTL/result/imputation_tbd/tbd_allsamplefile.txt"
do_impute2X $OUTPUT_HAPS $GENMAP_FILE $HAPS_FILE $LEGEND_FILE "${impfolder}/chunkresult/genotypes_imp_chr${chr}_PAR1_chunk" "${impfolder}/genotypes_imp_chr${chr}_PAR1.txt" "${impfolder}/genotypes_info_chr${chr}_PAR1.txt" $samplefile
...
#OUTPUT_HAPS=${outfolder}/genotypes_chr${chr}_PAR2.haps
OUTPUT_HAPS=${outfolder}/genotypes_chr${chr}_PAR1.haps
OUTPUT_SAMPLE=${outfolder}/genotypes_chr${chr}_PAR2.sample
OUTPUT_LOG=${outfolder}/genotypes_chr${chr}_PAR2.log
#All three phasing results are the same
##do_shapeitX $outfolder/genotypes_chr$chr $GENMAP_FILE $OUTPUT_HAPS $OUTPUT_SAMPLE $OUTPUT_LOG
do_impute2X $OUTPUT_HAPS $GENMAP_FILE $HAPS_FILE $LEGEND_FILE "${impfolder}/chunkresult/genotypes_imp_chr${chr}_PAR2_chunk" "${impfolder}/genotypes_imp_chr${chr}_PAR2.txt" "${impfolder}/genotypes_info_chr${chr}_PAR2.txt" $samplefile
...
#OUTPUT_HAPS=${outfolder}/genotypes_chr${chr}_nonPAR.haps
OUTPUT_HAPS=${outfolder}/genotypes_chr${chr}_PAR1.haps
OUTPUT_SAMPLE=${outfolder}/genotypes_chr${chr}_nonPAR.sample
OUTPUT_LOG=${outfolder}/genotypes_chr${chr}_nonPAR.log
##do_shapeitX $outfolder/genotypes_chr$chr $GENMAP_FILE $OUTPUT_HAPS $OUTPUT_SAMPLE $OUTPUT_LOG
do_impute2X $OUTPUT_HAPS $GENMAP_FILE $HAPS_FILE $LEGEND_FILE "${impfolder}/chunkresult/genotypes_imp_chr${chr}_nonPAR_chunk" "${impfolder}/genotypes_imp_chr${chr}_nonPAR.txt" "${impfolder}/genotypes_info_chr${chr}_nonPAR.txt" $samplefile
